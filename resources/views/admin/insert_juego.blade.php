...
<body>
    ...
    <button type="button" id="add-price" class="btn btn-secondary me-2">Agregar otro precio</button>
    <button type="submit" class="btn btn-primary me-2">Guardar Juego</button>
    <a href="{{ route('juegos') }}" class="btn btn-secondary">Cancelar</a>
</div>
</form>
...
<script>
    document.getElementById('add-price').addEventListener('click', function () {
        ...
        `;
        preciosDiv.appendChild(nuevoPrecio);
    });
</script>
</body>
